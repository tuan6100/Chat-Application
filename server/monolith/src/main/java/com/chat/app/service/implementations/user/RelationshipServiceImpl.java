...
public class RelationshipServiceImpl implements RelationshipService {
    ...
    public void inviteFriend(Long userId, Long friendId) throws ChatException {
        ...
        Account user = accountSearchService.searchAccountById(userId);
        Account friend = accountSearchService.searchAccountById(friendId);
    ...
    @Override
    public List<FriendStatusResponse> getInvitationsList(Long userId) {
        ...
        return invitations.stream()
                ...
                .map(rel -> new FriendStatusResponse(rel.getFirstAccount().getAccountId(), rel.getStatus().name()))
                .collect(Collectors.toList());
    }
